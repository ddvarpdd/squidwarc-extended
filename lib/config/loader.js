...
class Loader {
  ...
  static async load (confPath) {
    ...
    const chrome = Object.assign(
      {
        ...
        proxy: config.proxy != null ? config.proxy : false,
        ...defaultOpts.connect
      },
      config.chrome,
      config.connect
	...
	const screenshot = Object.assign(
      {
        ...defaultOpts.screenshot
      },
      config.screenshot
    )
	
    return { chrome, crawlControl, warc, seeds, logging, screenshot }
  }
